...
from locators import Header_locators, Login_form_locators, Main_page_locators

class TestEnterToConstructor:
    # переход из личного кабинета в конструктор
    def test_positive_enter_from_personal_profile_to_constructor(self, driver, login):
        ...
        WebDriverWait(driver, 10).until(EC.url_to_be(URL_MAIN))
